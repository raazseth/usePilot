...
## Context
Tauri apps require a backend runtime to handle database transactions, AI streaming, and local background workloads.
...
- **Native SQLite**: Bun provides built-in `bun:sqlite` with WAL mode.
