...
const STAGE_CONFIG: Record<PlanningStage, { label: string; sub: string }> = {
  ...
  detecting_missing_info: { label: 'Detecting Missing Info', sub: 'Checking for required non-inferrable parameters...' },
  analyzing: { label: 'Analyzing Intent', sub: 'Assessing capabilities and operational risk...' },
  ...
  explaining: { label: 'Explaining Plan', sub: 'Synthesizing strategy and architectural rationale...' },
