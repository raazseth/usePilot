...
function makeValidBlueprint(): ExecutionBlueprint {
  return {
    ...
    intent: {
      ...
      riskLevel: 'low',
      complexity: 'low',
      reasoning: 'Standard web interaction',
      suggestedTools: ['browser'],
      externalServices: ['Amazon'],
      confidence: 0.9,
    },
    tasks: [
      {
    ...
    graph: {
      nodes: [
        { taskId: 't-1', metadata: { layer: 0, isCritical: true, canParallelize: false } },
        { taskId: 't-2', metadata: { layer: 1, isCritical: true, canParallelize: false } },
      ],
